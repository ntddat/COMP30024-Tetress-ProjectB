...
from .generation import generate_states, create_state, generate_pieces
...
class Agent:
    ...
    *** AGENT THAT PLAYS COMPLETELY RANDOM MOVES ***
    ...
    def action(self, **referee: dict) -> Action:
        ...
        """
        pieces = generate_pieces(self._state, maxPlayer)
        pieces = list(pieces)
